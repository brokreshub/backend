...
exports.createFakeProperty = async (req, res) => {
    try {
        ...
        // Get random images from Unsplash with your access key
        ...
        const fakeProperty = {
            ...
            description: 'Beautiful property with amazing views and modern amenities. Features include high-end finishes, spacious layouts, and premium facilities.',
            ...
            amenities: {
                connectOrCreate: amenities
                    .slice(0, Math.floor(Math.random() * amenities.length) + 3) // Ensure at least 3 amenities
                    .map(amenity => ({
                        where: { name: amenity },
                        create: { name: amenity }
                    }))
